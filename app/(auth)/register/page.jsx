...
const API = process.env.NEXT_PUBLIC_API_BASE || "https://multibroker-trader-multiuser-render.onrender.com";
...
export default function RegisterPage() {
  ...
  return (
    <div className="card shadow p-4" style={{ width: 380 }}>
      ...
      <input className="form-control mb-3" placeholder="User ID" value={userid}
